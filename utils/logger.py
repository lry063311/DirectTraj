...
def log_info(args, logger):
    ...
    logger.info("channel_multipliers: {}".format(args.model.channel_multipliers))
    logger.info("channels: {}".format(args.model.channels))
    logger.info("attention_levels: {}".format(args.model.attention_levels))
    logger.info("n_heads: {}".format(args.model.n_heads))
    logger.info("d_cond: {}".format(args.model.d_cond))
    logger.info('***********************************')
